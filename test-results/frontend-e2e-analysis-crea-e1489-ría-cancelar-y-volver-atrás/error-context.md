...
- Name: frontend\e2e\analysis-creation.spec.ts >> Creación de Análisis Estadístico >> debería cancelar y volver atrás
- Location: frontend\e2e\analysis-creation.spec.ts:42:7
