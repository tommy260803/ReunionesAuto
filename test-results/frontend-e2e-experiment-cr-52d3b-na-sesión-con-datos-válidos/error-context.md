...
- Name: frontend\e2e\experiment-creation.spec.ts >> Creación de Sesión Experimental >> debería crear una sesión con datos válidos
- Location: frontend\e2e\experiment-creation.spec.ts:24:7
