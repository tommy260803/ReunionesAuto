...
- Name: frontend\e2e\research-dashboard.spec.ts >> Módulo de Investigación >> debería navegar a la página de evaluaciones
- Location: frontend\e2e\research-dashboard.spec.ts:32:7
