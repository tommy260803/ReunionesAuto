...
- Name: frontend\e2e\research-dashboard.spec.ts >> Módulo de Investigación >> debería mostrar estadísticas clave
- Location: frontend\e2e\research-dashboard.spec.ts:13:7
