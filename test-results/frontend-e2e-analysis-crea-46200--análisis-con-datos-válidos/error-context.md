...
- Name: frontend\e2e\analysis-creation.spec.ts >> Creación de Análisis Estadístico >> debería crear un análisis con datos válidos
- Location: frontend\e2e\analysis-creation.spec.ts:24:7
