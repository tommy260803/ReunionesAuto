...
- Name: frontend\e2e\research-dashboard.spec.ts >> Módulo de Investigación >> debería navegar a la página de experimentos
- Location: frontend\e2e\research-dashboard.spec.ts:26:7
