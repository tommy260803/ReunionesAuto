...
- Name: frontend\e2e\experiment-creation.spec.ts >> Creación de Sesión Experimental >> debería cancelar y volver atrás
- Location: frontend\e2e\experiment-creation.spec.ts:37:7
