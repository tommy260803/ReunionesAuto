...
- Name: frontend\e2e\experiment-creation.spec.ts >> Creación de Sesión Experimental >> debería requerir campos obligatorios
- Location: frontend\e2e\experiment-creation.spec.ts:15:7
