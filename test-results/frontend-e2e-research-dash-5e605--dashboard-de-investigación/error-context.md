...
- Name: frontend\e2e\research-dashboard.spec.ts >> Módulo de Investigación >> debería mostrar el dashboard de investigación
- Location: frontend\e2e\research-dashboard.spec.ts:9:7
