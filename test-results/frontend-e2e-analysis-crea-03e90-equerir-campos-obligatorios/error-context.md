...
- Name: frontend\e2e\analysis-creation.spec.ts >> Creación de Análisis Estadístico >> debería requerir campos obligatorios
- Location: frontend\e2e\analysis-creation.spec.ts:15:7
